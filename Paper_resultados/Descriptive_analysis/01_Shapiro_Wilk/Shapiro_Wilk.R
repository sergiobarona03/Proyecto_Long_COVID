...
normal$Skewness[2] = skewness(dataset$t_UCI_desc)
normal$Kurtosis[2] = kurtosis(dataset$t_UCI_desc)
normal$W[2] = as.numeric(shapiro.test(dataset$t_UCI_desc)$statistic)
normal$p_value[2] = as.numeric(shapiro.test(dataset$t_UCI_desc)$p.value)
