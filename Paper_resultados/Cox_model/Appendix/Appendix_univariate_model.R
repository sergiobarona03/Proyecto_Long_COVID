...
writexl::write_xlsx(univariate, 
                    "Paper_resultados/Cox_model/Appendix/Output/Univariate_model/Univariate_models.xlsx")
...
writeLines(univariate_latex_tex,
           "Paper_resultados/Cox_model/Appendix/Output/Univariate_model/Univariate_models.tex")
