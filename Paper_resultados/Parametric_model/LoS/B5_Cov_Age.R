...
parametric_g1 = fitdist(dataset_g1$t_UCI_desc, "gengamma",
...
quantile_g1 = data.frame(variable = c("Q1", "Q2", "Q3"),
                           ...
                           CI_2 = c(NA, NA, NA),
                           sample = c(NA, NA, NA))
quantile_function = function(x){qgengamma(x, mu = parametric_g1$estimate[1],
                                          sigma = parametric_g1$estimate[2],
                                          Q = parametric_g1$estimate[3])}
q = c(0.25,0.5,0.75)
for (k in 1:3) {
...
parametric_g2 = fitdist(dataset_g2$t_UCI_desc, "gengamma",
                        start = list(mu = 1, sigma = 1, Q = 1))
...
quantile_g2 = data.frame(variable = c("Q1", "Q2", "Q3"),
                         ...
                         CI_2 = c(NA, NA, NA),
                         sample = c(NA, NA, NA))
quantile_function = function(x){qgengamma(x, mu = parametric_g2$estimate[1],
                                          sigma = parametric_g2$estimate[2],
                                          Q = parametric_g2$estimate[3])}
q = c(0.25,0.5,0.75)
for (k in 1:3) {
