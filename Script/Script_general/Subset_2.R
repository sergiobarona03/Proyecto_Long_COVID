...
#Definir el periodo
t_0 <- as.Date("2021-03-31")  
t_T <- as.Date("2021-05-31")  
...
for (j in 1:N)
{
  ...
  destfile [[j]] =paste0("C:\\Users\\Clase\\Desktop\\Subset\\Subset2\\",format[j])
  #MacOS:
...
dataframe_subset_2 <- dataframe_test

write.csv(dataframe_subset_2, 
          "/Volumes/SERGIOB/Proyecto_S.22.08.22/dataframe_subset_2", 
          row.names = FALSE)