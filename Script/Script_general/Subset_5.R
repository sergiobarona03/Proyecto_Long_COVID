...
#Definir el periodo
t_0 <- as.Date("2021-09-30")  
t_T <- as.Date("2021-11-30")  
fechas <- seq(from=t_0, to=t_T, by=1)
fechas <- fechas[-which(fechas == "2021-10-31")]
...
dataframe_subset_5 <- dataframe_test

write.csv(dataframe_subset_5, 
          "/Volumes/SERGIOB/Proyecto_S.22.08.22/dataframe_subset_5", 
          row.names = FALSE)