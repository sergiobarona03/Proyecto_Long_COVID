...
#Definir el periodo
t_0 <- as.Date("2021-05-31")  
t_T <- as.Date("2021-07-31")  
...
dataframe_subset_3 <- dataframe_test

write.csv(dataframe_subset_3, 
          "D:\\Desktop\\Subset_5\\Resultado\\dataframe_subset_3.csv", 
          row.names = FALSE)
